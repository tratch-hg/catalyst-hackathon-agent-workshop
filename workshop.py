...
===================================================================
This file walks through 5 progressive steps, each a self-contained runnable
...
# ===========================================================================
# STEP 5 — Full agent (same as agent.py, condensed for teaching)
# ===========================================================================
...
STEP = 1          # ← change this to 1, 2, 3, 4, or 5
...
if __name__ == "__main__":
    ...
    if fn:
        ...
        print(f"Unknown step: {STEP}. Choose 1–5.")
